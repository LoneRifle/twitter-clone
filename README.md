...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create majulah-b98d
  fly apps create majulah-b98d-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app majulah-b98d
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app majulah-b98d-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'majulah-b98d-staging' does not match app name in config file 'majulah-b98d'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name majulah-b98d-db
  fly postgres attach --app majulah-b98d majulah-b98d-db

  fly postgres create --name majulah-b98d-staging-db
  fly postgres attach --app majulah-b98d-staging majulah-b98d-staging-db
  ```
